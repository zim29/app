    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border-left:0; border-right:0;" valign="middle">
                <center><?= $invoice["Invoice"]["payment_method"] ?><?= $invoice["Invoice"]["payment_method"] == 'Paypal' ? ' (3.4% fee)' : '' ; ?></center>
            </td>
            <td style="border-left:0; border-right:0;" valign="middle">
...
<?php if ($invoice['Invoice']['payment_method'] == 'Bank Transfer') { ?>
	...
	<table border="1" cellpadding="3" cellspacing="0" style="font-size:10px;" width="100%">
	    <tbody>
            <tr>
	            <td width="100%">
	                Beneficiary: <b>David Nieves Coronado</b>
	            </td>
	        </tr>
	        <tr>
	            <td width="100%">
	                IBAN: <b>ES4201822857160201673993</b>
	            </td>
	        </tr>
            <tr>
	            <td width="100%">
	                Concept: <b>Custom develop <?= $invoice["Invoice"]["customer_name"]; ?></b>
	            </td>
	        </tr>
	    </tbody>
	</table>
