...
function _get_tab_feeds() {
    var tab_feeds = $('div#tab-feeds').length ? $('div#tab-feeds') : $('div#tab-Новостные-ленты');
    return tab_feeds;
}
...
function check_feed_type(type) {
	...
	$('[class~="exclude_in_"]').show();
	$('.exclude_in_'+type).hide();
