...
function remodal_notification(message, class_custom, position) {
	...
	var message = '<div class="alert alert-'+class_custom+' alert-dismissible fade show" role="alert"><i class="fas fa-'+icon_class+'"></i> '+message+'<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
