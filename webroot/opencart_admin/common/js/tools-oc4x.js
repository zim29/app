...
function check_toogle_main_fields(checkbox) {
	...
	var checked = checkbox.is(':checked') && checkbox.closest('div.toogle_main_field').css('display') == 'flex';
...
function ajax_loading_open(container) {
	if (typeof container !== 'undefined') {
		jQuery(container).prepend('<div class="ajax_loading container"><i class="fas fa-sync fa-spin"></i></div>');
	} else { 
		jQuery('body').prepend('<div class="ajax_loading"><i class="fas fa-sync fa-spin"></i></div>');
	}
}
